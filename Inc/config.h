...
// BRAKE 0,838V => 2,420V       Translate to ADC values f(x) = (x * 4095) / 3.3
// BRAKE 1047 => 3024
#define PRI_INPUT1 1, 1047, 2047, 3024, 0 // Pedal Brake        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
